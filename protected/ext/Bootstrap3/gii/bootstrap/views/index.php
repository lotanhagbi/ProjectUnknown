...
<?php $form = $this->beginWidget('CCodeForm', array('model' => $project)); ?>

    <div class="row">
        <?php echo $form->labelEx($project, 'model'); ?>
        <?php echo $form->textField($project, 'model', array('size' => 65)); ?>
        <div class="tooltip">
        ...
        <?php echo $form->error($project, 'model'); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($project, 'controller'); ?>
        <?php echo $form->textField($project, 'controller', array('size' => 65)); ?>
        <div class="tooltip">
        ...
        <?php echo $form->error($project, 'controller'); ?>
    </div>

    <div class="row sticky">
        <?php echo $form->labelEx($project, 'baseControllerClass'); ?>
        <?php echo $form->textField($project, 'baseControllerClass', array('size' => 65)); ?>
        <div class="tooltip">
            This is the class that the new CRUD controller class will extend from.
            Please make sure the class exists and can be autoloaded.
        </div>
        <?php echo $form->error($project, 'baseControllerClass'); ?>
    </div>
